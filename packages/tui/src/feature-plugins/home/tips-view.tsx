...
// The model list comes from the gateway, not from a provider the user connects — /connect is inert
// in this build (enabled_providers is re-pinned to `opviera` on every launch).
export const NO_MODELS_TIP = "Run {highlight}opviera login{/highlight} to connect your Opviera gateway key"
...
/** Exported for the branding guard in test/feature-plugins/tips-view.test.ts. */
export const TIPS: Tip[] = [
  ...
  "Run {highlight}/share{/highlight} to create a public link to the session",
  ...
  "Create {highlight}opviera.json{/highlight} for server settings, and {highlight}tui.json{/highlight} for TUI",
  "Place TUI settings in {highlight}~/.config/opviera/tui.json{/highlight} for global config",
  ...
  "Use {highlight}opviera run{/highlight} for non-interactive scripting",
  "Use {highlight}opviera --continue{/highlight} to resume the last session",
  "Use {highlight}opviera run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}opviera serve{/highlight} for headless API access",
  "Use {highlight}opviera run --attach{/highlight} to connect to a running server",
  "Run {highlight}opviera providers list{/highlight} to see all configured providers",
  "Run {highlight}opviera agent create{/highlight} for guided agent creation",
  ...
  "Run {highlight}opviera debug config{/highlight} to troubleshoot configuration",
